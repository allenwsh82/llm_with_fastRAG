...
#sharelink_url = "https://s3.eu-central-1.amazonaws.com/deepset.ai-farm-qa/datasets/small_generator_dataset.csv.zip"
...
title = "Generative QA with RAG with CSV Format Knowledge Database powered Intel Xeon 4th Gen 8480+ CPU"


QUESTIONS = [
    "When did Intel announce Intel Core 14th Gen mobile processor?",
    "When and where did Intel announce AI Everywhere?",
    "What is AI PC?",
    "What is Gaudi 3?",
    "What is Intel Application Optimization (APO)?",
